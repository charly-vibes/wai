---
name: verify-prompt
description: Compare original and distilled prompts to verify the distillation is faithful and lossless. Checks completeness, accuracy, and appropriate conciseness.
---

# Verify Prompt Distillation
