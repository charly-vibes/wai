...
```
○ wai-bdqw ● P1 [epic] Acknowledge and integrate the full charly tool-suite (pretender, dont, espectacular, testaruda, vampiro, crua, livin)
└── ○ wai-bdqw.7 ● P3 Fix WAI managed-block / 'tracked with wai' badge mismatch in pretender, espectacular, testaruda
