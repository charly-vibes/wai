...
```
○ wai-cjnx ● P1 [epic] [epic] Fix 16 clippy errors across wai
├── ○ wai-cjnx.6 ● P1 [bug] fix boolean logic bug in expression
├── ○ wai-cjnx.1 ● P2 [bug] fix useless vec! in src/commands/add.rs
├── ○ wai-cjnx.2 ● P2 [bug] fix useless format! in lib test
├── ○ wai-cjnx.3 ● P2 [bug] fix unused imports in genesis_fixture_test
├── ○ wai-cjnx.4 ● P2 [bug] fix unused variable marker in lib test
├── ○ wai-cjnx.5 ● P2 [bug] fix manual Option::map implementations
├── ○ wai-cjnx.7 ● P2 [bug] fix items after test module
├── ○ wai-cjnx.8 ● P2 [bug] fix field assignment outside Default::default() initializer
└── ○ wai-cjnx.9 ● P2 [bug] fix function init_workspace never used
...
○ wai-me1d ● P1 [bug] phantom wai init --update flag referenced in error messages and docs
